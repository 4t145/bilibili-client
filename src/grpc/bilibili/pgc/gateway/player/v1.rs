...
pub mod play_url_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn play_view(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bilibili.pgc.gateway.player.v1.PlayURL", "PlayView"),
                );
        ...
        pub async fn project(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bilibili.pgc.gateway.player.v1.PlayURL", "Project"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// 直播播放页信息
        pub async fn live_play_view(
            ...
            tonic::Response<super::LivePlayViewReply>,
            tonic::Status,
        > {
            self.inner
                .ready()
