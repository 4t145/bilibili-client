...
pub struct SearchByTypeRequest {
    ...
    pub keyword: ::prost::alloc::string::String,
    ///
    #[prost(enumeration = "search_by_type_request::CategorySort", tag = "3")]
    pub category_sort: i32,
    ///
    #[prost(int64, tag = "4")]
    pub category_id: i64,
    ///
    #[prost(enumeration = "search_by_type_request::UserType", tag = "5")]
    pub user_type: i32,
    ///
    #[prost(enumeration = "search_by_type_request::UserSort", tag = "6")]
    pub user_sort: i32,
    ///
    #[prost(message, optional, tag = "7")]
    pub pagination: ::core::option::Option<
...
/// Nested message and enum types in `SearchByTypeRequest`.
pub mod search_by_type_request {
    #[derive(
        Clone,
        Copy,
        Debug,
