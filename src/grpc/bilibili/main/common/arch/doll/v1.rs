...
pub mod echo_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn ping(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bilibili.main.common.arch.doll.v1.Echo", "Ping"),
                );
        ...
        pub async fn say(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bilibili.main.common.arch.doll.v1.Echo", "Say"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn error(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bilibili.main.common.arch.doll.v1.Echo", "Error"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
